...
## Corpus Check
- 232 files · ~165,375 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1691 nodes · 2663 edges · 191 communities (149 shown, 42 thin omitted)
...
### Community 0 - "cli.py"
Cohesion: 0.14
Nodes (24): build_parser(), cmd_arm(), cmd_autostart(), cmd_config(), cmd_disarm(), cmd_doctor(), cmd_events(), cmd_health() (+16 more)
...
Cohesion: 0.06
Nodes (22): Indicator, main(), AudioIntercom, play_audio(), Path, Visible near-live voice intercom.      Bale Bot API transports voice/audio messa, record_audio(), normalize_voice() (+14 more)
...
### Community 7 - "BaleApi"
Cohesion: 0.14
Nodes (28): _apply_legacy_env(), _apply_section(), _atomic_write_private(), _coerce_like(), default_api_base(), ensure_dirs(), get_api_token(), get_bot_token() (+20 more)

### Community 8 - "StopPinStore"
Cohesion: 0.06
Nodes (49): _failed_login_monitor_ok(), main(), _persian_tts_ok(), _psutil_ok(), run_doctor(), _tk_ok(), _video_player_ok(), _warning_video_ok() (+41 more)
...
Cohesion: 0.22
Nodes (5): Any, Path, Protocol, Transport contract consumed by the guard runtime.      Feature code depends on t, RuntimeApi

### Community 13 - "config.py"
Cohesion: 0.28
Nodes (15): BaseException, _ask_valid_token(), _auth_error(), ensure_runtime_configuration(), _interactive(), _pair_owner_chat(), _provider(), _provider_name() (+7 more)

### Community 14 - "AppConfig"
Cohesion: 0.15
Nodes (14): AppConfig, test_enabling_for_next_login_does_not_start_immediately(), test_startup_and_arming_are_separate_defaults(), test_chat_defaults_to_two_minutes_and_allows_visitor_reply(), Path, test_setup_complete_checkpoint(), test_default_warning_sequence_is_five_seconds(), test_protected_stop_defaults() (+6 more)
...
Cohesion: 0.25
Nodes (11): cmd_test(), build_provider(), lock_screen(), run_first(), unlock_screen(), test_bot(), test_camera(), test_input() (+3 more)
...
Cohesion: 0.23
Nodes (13): camera_label(), CameraDevice, _decode_c_string(), discover_cameras(), _linux_capability(), open_camera(), probe_camera(), Path (+5 more)
...
Cohesion: 0.26
Nodes (5): build_runtime_api(), LocalRuntimeApi, No-network runtime adapter for local-only installations., test_local_runtime_does_not_require_bot_token(), test_remote_runtime_receives_configured_proxy()
...
Cohesion: 0.80
Nodes (4): Path, _redirect_paths(), test_legacy_secret_import_is_optional_without_environment(), test_tokens_are_private_and_separate_from_config()
...
Cohesion: 0.83
Nodes (3): _load_checker(), test_current_git_index_contains_no_blocked_secret_paths(), test_secret_filename_policy()
...
- **Why does `LaptopGuard` connect `LaptopGuard` to `cli.py`, `guard.py`, `SecurityChatManager`, `StopPinStore`, `EventStore`, `AudioConfig`, `RuntimeStateStore`, `config.py`, `RuntimeApi`, `ScreenCaptureManager`, `launch_warning`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `AppConfig` connect `AppConfig` to `cli.py`, `test_secret_config.py`, `guard.py`, `build_runtime_api`, `apply_profile`, `BaleApi`, `RuntimeStateStore`, `test_config_robustness.py`, `config.py`, `test_v33_features.py`, `test_persian_tts.py`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `build_provider()` connect `runtime_config.py` to `config.py`, `HttpBotProvider`, `BaleApi`?**
