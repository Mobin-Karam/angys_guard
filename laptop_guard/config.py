...
def _apply_legacy_env(cfg: AppConfig) -> None:
    ...
    mapping: list[tuple[str, Any, str]] = [
        ...
        ("SOUND_DETECTION_ENABLED", cfg.audio, "sound_detection_enabled"),
        ("SOUND_THRESHOLD", cfg.audio, "sound_threshold"),
        ("SOUND_TRIGGER_CHUNKS", cfg.audio, "sound_trigger_chunks"),
        ("SOUND_RECORD_SECONDS", cfg.audio, "sound_record_seconds"),
        ("SOUND_COOLDOWN", cfg.audio, "sound_cooldown"),
